...
class MWSAPI(MWSConnection):
    ...
    def get_orders(self, order_number_list):
        if len(order_number_list) > 50:
            log.error('Too many order numbers')
            return None

        kw = {'AmazonOrderId': order_number_list}
        response = self.get_order(**kw)
...
if __name__ == '__main__':
    ...
    result = api.get_orders(['306-6958112-3919544', '306-8062542-0920308'])
    print result
